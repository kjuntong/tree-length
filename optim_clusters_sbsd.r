...
print(paste('opt k is' , opt_k))
  ...
  return(list(optimal_k = opt_k, cluster_info = clus_info, cluster_id =  clus_id, gap_statistics = gap_stats, mds = mds_dat, mean_gaps, high_gaps))
}

#test_1 <- optim_clusters_sbsd('sbsd.txt', n_clusters = 4, kmax = 50, b_reps = 100, plot_clustering = T)